            ...
            <div class="panel panel-default">
                <div class="panel-body" style="padding-top: 0">
                    ...
                    <p aria-label="Left Align">
                        ...
                        {{date('Y-m-d', strtotime($currEvent->dateTimeFrom))}}
                        Kl. {{date('H:i', strtotime($currEvent->dateTimeFrom))}}
                        - {{date('Y-m-d', strtotime($currEvent->dateTimeTo))}}
                        Kl. {{date('H:i', strtotime($currEvent->dateTimeTo))}}
                    </p>
                    ...
                    @if(Auth::check())
                        ...
                        @if($currEvent->reg == 1&&(Auth::user()->level>=1||Auth::user()->id == $currEvent->createdBy))
                            <p>
